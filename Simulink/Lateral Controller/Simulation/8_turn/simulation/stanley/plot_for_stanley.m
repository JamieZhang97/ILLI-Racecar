...
%     l3 = plot(xo, yo,'*r');
    hold on;
    plot([xo(i) xo(i) + 0.3*cos(theta(i))], [yo(i) yo(i) + 0.3*sin(theta(i))],'red', 'linewidth',1);
    x_tri = [xo(i)+0.4*cos(theta(i)), xo(i) + 0.4*cos(theta(i)) - 0.15*cos(theta(i)+0.2), xo(i) + 0.4*cos(theta(i)) - 0.15*cos(theta(i)-0.2), xo(i)+0.4*cos(theta(i))];
    y_tri = [yo(i)+0.4*sin(theta(i)), yo(i) + 0.4*sin(theta(i)) - 0.15*sin(theta(i)+0.2), yo(i) + 0.4*sin(theta(i)) - 0.15*sin(theta(i)-0.2), yo(i)+0.4*sin(theta(i))];
